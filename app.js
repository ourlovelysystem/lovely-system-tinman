(()=>{
  ...
  $('modeCopy').textContent=mode==='appeal'?'Preferred outward-facing contact surface. Recordings are inspectable here.':'Preferred outward-facing contact surface. Recordings are inspectable here.';
  if(!$('title')){
